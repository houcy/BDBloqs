    ...
    var load = function(options) {
        ...
        (function() {
            var language = {
                ...
                LANG_VARIABLES_PIN_DIGITAL0: 'WARNING: digital pin 0 (RX pin) is used\n when uploading a sketch. Using it to\nconnect electronic components may cause\n problems when uploading a new sketch.',
                ...
                LANG_ZUM_PIEZO_BUZZERAV: 'Buzzer',
        ...
        (function() {
            var language = {
                ...
                LANG_VARIABLES_PIN_DIGITAL0: 'CUIDADO: el pin digital 0 (pin Rx) es usado para\n escribir un programa en la placa desde el ordenador.\n Usarlo para conectar componentes puede dar\n problemas al programarla.',
                ...
                LANG_ZUM_PIEZO_BUZZERAV: 'Zumbador',
                LANG_ZUM_PIEZO_BUZZERAV_PIN: 'PIN#',
        ...
        (function() {
            var language = {
                ...
                LANG_ZUM_PIEZO_BUZZERAV: 'Burrunbagailu',
                LANG_ZUM_PIEZO_BUZZERAV_PIN: 'PIN#',
                LANG_ZUM_PIEZO_BUZZERAV_TONE: 'TONUA',
                LANG_ZUM_PIEZO_BUZZERAV_DURATION: 'Iraupena [ms]',
                LANG_ZUM_PIEZO_BUZZERAV_TOOLTIP: 'Burrunbagailu',
