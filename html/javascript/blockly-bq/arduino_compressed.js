...
Blockly.Arduino.finish = function(a) {
    ...
    var d = [],
        ...
        e = [],
        f;
    for (f in Blockly.Arduino.definitions_) b = Blockly.Arduino.definitions_[f], b.match(/^#include/) ? d.push(b) : 0 <= f.search("declare_var") ? e.push(b) : c.push(b);
    b = Blockly.Arduino.orderDefinitions(c);
    c = [];
    for (f in Blockly.Arduino.setups_) c.push(Blockly.Arduino.setups_[f]);
    a = (d.join("\n") + "\n\n/* Variables Globales */\n" + e.join("") + "\n\n/* Inicializaciones */\n" +
